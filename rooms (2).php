  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 mx-auto">
        ...
        <div id="roomType">
          <h3 class="p3" style="font-size: 30px; margin-top : 1rem;">
            <?php
            require 'connect.php';
            $sql = "SELECT * FROM room WHERE id_room='" . $tipe . "'";
            $res = mysqli_query($con, $sql);
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-5 mx-auto" style="text-align: right; margin-right : -8rem;">
              <?php
			...
			<div class="modal-dialog">
				...
				<div class="modal-body">
                  ...
                  <div class="row justify-content-center" >
                    ...
                    <div class="col-4">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="value4" id="flexCheckDefault" name = "smoking2" >
                      <label class="form-check-label" for="flexCheckDefault">
                        Smoking Room
                      </label>
                      </div>
